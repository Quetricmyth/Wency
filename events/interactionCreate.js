    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        if(!rulesisread) {
          ...
          .setDescription("\n\n**<:links:1039607057923461181> Linkler**\n> <:newmember:1044325552007422052>・**Botun destek sunucusu: [Tıkla](https://discord.gg/Y8x2dGEAu4)**")
          .setColor('Blue')
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:mod:1039607060775571476> | Wency - Moderasyon Menüsü!")
          .addFields(
      ...
      .setTitle("> <:mod:1039607060775571476> | Wency - Moderasyon 2 Menüsü!")
      .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:ek:1039607052340834354> | Wency - Kayıt Menüsü!")
          .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:member:1039607059357913098> | Wency - Kullanıcı Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setAuthor({ name: "Wency Sistemler Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**Linkler**\n> ・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1136273116792881213&permissions=8&scope=bot)**\n> ・**Botun destek sunucusu: [Tıkla](https://discord.gg/Y8x2dGEAu4)**\n>")
          .setColor('Blue')
        ...
        if (interaction.customId == "korumasystem_"+interaction.user.id) {
          const embed = new Discord.EmbedBuilder()
          .setTitle("> <:koruma:1044325545925672976> | Wency - Koruma Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:bot:1039607042291269703> | Wency - Botlist Menüsü!")
          .addFields(
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> <:ses:1041739960493019197> | Wency - Özel Oda Menüsü!")
      .addFields(
      ...
      .setColor("Random")
        ...
        if (interaction.customId == "anasayfa_"+interaction.user.id) {
          const embed = new EmbedBuilder()
          .setAuthor({ name: "Wency Yardım Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**Linkler**\n> ・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1136273116792881213&permissions=8&scope=bot)**\n> ・**Botun destek sunucusu: [Tıkla](https://discord.gg/Y8x2dGEAu4)**\n>")
          .setColor('Blue')
          const row = new Discord.ActionRowBuilder()
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:yenilik:1044325577064190033> | Wency - Ticket Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Wency - Level Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Wency - Captcha Menüsü!")
          .addFields(
        ...
        `)
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Wency Bot - İyi günler diler.')
      ...
      .setTitle('Wency - Özel Oda Kullanıcı Ekleme!')
        ...
        .setTitle('Wency - Özel Oda Kullanıcı Çıkarma!')
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "Wency Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
